...
<body>
    ...
    <div id="wrapper" style="background: #ad7d0a;">
        ...
        <div id="page-wrapper" style="background:#e3ad0b;">
<?php 
		if ($satu['nisn']==''){
?>
			<div class="row">
                                    ...
                                    <form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="form-group col-lg-6">
												...
												<input class="form-control" name="nisn" type="text" value="<?php echo $satu['nisn'];?> / <?php echo $satu['nis'];?>">
											</div><div class="form-group col-lg-6"></div>
										</div>
										<div class="row">
											<div class="form-group col-lg-6">
												<label>Nama</label>
												<input class="form-control" name="nisn" type="text" value="<?php echo $satu['nama'];?>">
											</div><div class="form-group col-lg-6"></div>
										</div>
										<div class="row">
											<div class="form-group col-lg-6">
